...
# Copilot must follow these rules for ALL code in this repository.
...
Copilot must never generate code that bypasses or rearranges this flow.
...
Copilot must refuse to generate DOM access in forbidden layers.
...
When Copilot refactors code, it must:
...
Copilot must follow these rules for every change in this repository.
